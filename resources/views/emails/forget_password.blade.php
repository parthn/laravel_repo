...
<table width="100%" cellpadding="0" cellspacing="0">
    <tr>
        <td style="{{ $style['email-wrapper'] }}" align="center">
            <table width="100%" cellpadding="0" cellspacing="0">
                <!-- Logo -->
                <tr style="background-image: url('https://staging19.anythingwithink.com/order_email/mail-header.jpg');background-size: cover;">
                    <td style="{{ $style['email-masthead'] }}">
                        <a style="{{ $fontFamily }} {{ $style['email-masthead_name'] }}"
                           href="{{ config('app.front_url') }}" target="_blank">
                            {{--<img style="height: 270px;" width="200" src="{{config('app.url')}}/images/logo.png"/>--}}
                            <img alt="{{ config('app.name') }}"
                                 src="https://optamark.anythingwithink.com/profiles/logo/awi-logo-final2.png"/>
                        </a>
                    </td>
                </tr>
                        ...
                        <table style="{{ $style['email-footer'] }}" align="center" width="570" cellpadding="0"
                            ...
                            <tr>
                                <td style="{{ $fontFamily }} {{ $style['email-footer_cell'] }}">
                                    <p style="{{ $style['paragraph-sub'] }}">
                                        &copy; {{ date('Y') }}
                                        <a style="{{ $style['anchor'] }}" href="{{config('app.front_url') }}"
